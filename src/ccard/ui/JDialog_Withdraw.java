...
public class JDialog_Withdraw extends javax.swing.JDialog
{
	...
	void JButtonOK_actionPerformed(java.awt.event.ActionEvent event)
	{
        ...
        parentframe.getCCard().doTransaction(accNo, amount, "Charge");

        parentframe.amountDeposit = String.valueOf(parentframe.getCCard().getAccount(accNo).getBalance());
