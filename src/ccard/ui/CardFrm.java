...
//        rowdata = new Object[8];
	...
	static public void main(String args[])
	{
		try {
			...
			(new CardFrm(new CCard())).setVisible(true);
		} 
		catch (Throwable t) {
			t.printStackTrace();
	...
	void JButtonNewCCAC_actionPerformed(java.awt.event.ActionEvent event)
	{
		...
		*/
		...
		JDialog_AddCCAccount ccac = new JDialog_AddCCAccount(thisframe,cCard);
		ccac.setBounds(450, 20, 320, 390);
		ccac.show();
	...
	{
		JDialogGenBill billFrm = new JDialogGenBill(this,cCard);
	...
	void JButtonDeposit_actionPerformed(java.awt.event.ActionEvent event)
	{
        ...
        if (selection >= 0){
            String accNum = (String)model.getValueAt(selection, 1);
    	    
		    //Show the dialog for adding deposit amount for the current mane
		    JDialog_Deposit dep = new JDialog_Deposit(thisframe,accNum);
		    ...
		    model.setValueAt(amountDeposit,selection, 4);
		}
	...
	void JButtonWithdraw_actionPerformed(java.awt.event.ActionEvent event)
	{
        ...
        if (selection >=0){
		    ...
		    JDialog_Withdraw wd = new JDialog_Withdraw(thisframe,accNum);
		    ...
		    // long newamount=currentamount-deposit;
		    model.setValueAt(amountDeposit,selection, 4);
		    if (Double.parseDouble(amountDeposit) <0){
		       JOptionPane.showMessageDialog(JButton_Withdraw, " "+accNum+" Your balance is negative: $"+amountDeposit+" !","Warning: negative balance",JOptionPane.WARNING_MESSAGE);
		    }
		}
