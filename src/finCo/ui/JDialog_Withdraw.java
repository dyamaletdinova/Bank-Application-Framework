...
public class JDialog_Withdraw extends javax.swing.JDialog
{
	...
	public JDialog_Withdraw(FincoFrm parent, String aaccnr)
	{
		super(parent);
		parentframe=parent;
		accnr=aaccnr;
	...
	{
		int amount = Integer.parseInt(JTextField_AMT.getText())*-1;
        String accNo = JTextField_NAME.getText();

        parentframe.getFinco().doTransaction(accNo, amount, "Withdraw");

        parentframe.amountDeposit = String.valueOf(parentframe.getFinco().getAccount(accNo).getBalance());
