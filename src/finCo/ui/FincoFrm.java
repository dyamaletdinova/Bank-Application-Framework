...
public class FincoFrm extends javax.swing.JFrame {
	...
	public FincoFrm() {
		...
		JButton_generateReport.setBounds(468, 90,96 , 33);
	...
	class SymWindow extends java.awt.event.WindowAdapter {
		public void windowClosing(java.awt.event.WindowEvent event) {
			...
			if (object == FincoFrm.this)
				windowClosing_Interaction1(event);
		}
	}
	...
	void windowClosing_Interaction1(java.awt.event.WindowEvent event) {
		try {
	...
	void JButtonGenerateReport_actionPerformed(ActionEvent event) {
		JDialogGenRep billFrm = new JDialogGenRep(this,finco);
	...
	void JButtonDeposit_actionPerformed(java.awt.event.ActionEvent event) {
		...
		if (selection >= 0) {
			...
			model.setValueAt(amountDeposit, selection, 5);
		}
		...
		if (selection >= 0) {
			...
			if (Double.parseDouble(amountDeposit) < 0) {
				JOptionPane.showMessageDialog(JButton_Withdraw,
						" Account " + accnr + " : balance is negative: $" + amountDeposit + " !",
