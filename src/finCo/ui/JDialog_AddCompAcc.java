...
public class JDialog_AddCompAcc extends javax.swing.JDialog
{
	...
	public JDialog_AddCompAcc(FincoFrm parent)
	{
		super(parent);
		parentframe=parent;
	...
	void JButtonOK_actionPerformed(java.awt.event.ActionEvent event)
	{
       ...
       parentframe.numOfEmpl=JTextField_NoOfEmp.getText();
       
       parentframe.accountType="Default";
       ClientData cd = new ClientData(parentframe.accountType, parentframe.accountnr, parentframe.clientName, parentframe.street, parentframe.city, parentframe.state, parentframe.zip, parentframe.email,
				CustomerType.ORGANIZATION, parentframe.amountDeposit, parentframe.birthdate, parentframe.numOfEmpl);
       parentframe.getFinco().addAccount(cd);
